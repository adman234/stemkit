            ...
            >
              ...
              {!working && (
                <span
                  ...
                  className="no-drag shrink-0 flex items-center justify-center w-8 h-8 md:w-auto md:h-auto md:p-1 bg-white/[0.07] md:bg-transparent text-white/70 md:text-white/40 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity rounded-md hover:bg-white/10 hover:text-rose-300"
                >
