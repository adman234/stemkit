from models.btc.transformer_modules import *
from models.btc.transformer_modules import _gen_timing_signal, _gen_bias_mask
# the HParams import from the original repo is dropped: chords.py passes a
# plain dict, so the yaml config loader is not needed
